...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{MKB/UE_01/Hausuebungen/Grafiken/UE1_H1_A.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{MKB/UE_01/Hausuebungen/Grafiken/UE1_H1_B.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{MKB/UE_01/Hausuebungen/Grafiken/UE1_H1_C.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=0.6\textwidth]{MKB/UE_01/Hausuebungen/Grafiken/UE1_H1_D.png}
	\caption{ Dimetrische Projektion}
	\label{fig:H1_D}
\end{figure}
\end{Loesung}
%SPLITAufgabe
\label{Aufgabe_Kuboktaeder}
\footnotesize\\[-4ex]
